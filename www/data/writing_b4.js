...
window.IELTS_DATA.writing.push(
  {
    id: "w013", task: 1, type: "Process diagram description", title: "How Chocolate is Produced", min_words: 150,
    ...
    band_tips: "Process diagram task high score key: 1) The Overview should state the total number of stages and the start/end points (e.g., from cocoa tree to finished product), without elaborating on details; 2) Primarily use passive voice throughout (\"are harvested / is roasted / are crushed\") to maintain an objective description; 3) Use a rich and varied range of sequential linking words (\"at the start / then / after this / once / subsequently / at the final stage\"); 4) Strictly describe the process according to the diagram's sequence, omitting no steps, adding no numbers, and no personal opinions.",
    checklist: [
  ...
  {
    id: "w014", task: 1, type: "Mixed charts (bar + pie)", title: "Energy Production and Spending", min_words: 150,
    ...
    band_tips: "Multiple charts task high score key: 1) The Overview must summarise the overall patterns of both charts separately, without mixing them; 2) Clearly distinguish between the two charts and accurately use their respective units (e.g., \"power generation units/budget percentages\"); 3) Dedicate one main body paragraph to each chart; use trend vocabulary for bar charts (\"rose to / fell steadily / overtook\") and proportional vocabulary for pie charts (\"the largest share / accounted for / just 10 per cent\"); 4) Where possible, show how the two charts relate to each other (e.g., investment and power generation trends align), demonstrating analytical ability; avoid personal opinions.",
    checklist: [
  ...
  {
    id: "w015", task: 2, type: "Opinion (agree / disagree)", title: "Should Children Use Smartphones?", min_words: 250,
    ...
    band_tips: "Agree/Disagree (To what extent do you agree or disagree) Key points for an 8-band score: 1) The introduction must clearly state your position (fully agree/largely agree/disagree) and maintain a consistent stance throughout the essay; 2) Even when stating your position, include a concession paragraph acknowledging the opposing view, then refute it to demonstrate critical thinking; 3) Each paragraph should follow PEEL (Point-Explanation-Example-Link), with arguments supported by specific, credible examples; 4) Use a wide variety of cohesive devices and sentence structures (e.g., concessive clauses, relative clauses, passive voice, nominalisations such as 'stimulation'/'development', subjunctive mood), with precise and idiomatic vocabulary. The conclusion should reiterate your stance.",
    checklist: [
      "引言改写题目并明确表明同意程度的立场",
      "我方核心论点有解释与具体例子支撑",
      "有让步段承认对立面并加以反驳",
  ...
  {
    id: "w016", task: 2, type: "Problems and solutions", title: "Traffic Congestion in Cities", min_words: 250,
    ...
    band_tips: "Problems and Solutions (problems / causes and solutions) Key points for an 8-band score: 1) The introduction should paraphrase the prompt and preview a 'causes first, then solutions' structure; 2) Cause paragraphs and solution paragraphs should ideally correspond one-to-one (each cause having a corresponding measure), ensuring tight logical coherence; 3) Measures must be specific, feasible, and explain their impact (rather than vague 'strengthening management'); 4) Each paragraph should follow PEEL, using diverse cohesive devices and sentence structures (e.g., concessive clauses, relative clauses, passive voice, nominalisations such as 'congestion'/'ownership'), with precise vocabulary. The conclusion should summarise the causes and solutions and call for collective effort.",
    checklist: [
      "引言改写题目并预告成因与对策的结构",
      "成因段分析了多个具体且可信的原因",
      "对策段提出具体、可行的措施并说明作用",
