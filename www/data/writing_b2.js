...
window.IELTS_DATA.writing.push(
  {
    ...
    outline: [
      ...
      "概述(Overview):指出最突出的总体趋势(如煤炭持续下降、可再生能源大幅上升),不写具体数字",
      "主体段1:描述并比较起点(2000年)各能源的水平及前期变化",
      "主体段2:描述后期(尤其交叉点与终点2020年)的趋势与对比,点明谁超过谁",
      "全程用过去时与趋势词;数据有取舍、突出转折点,不写个人观点"
    ],
    useful_phrases: [
      { en: "The line graph illustrates the changes in...over a 20-year period.", zh: "该折线图展示了……在20年间的变化。" },
      { en: "There was a steady upward trend in..., whereas...declined sharply.", zh: "……呈稳步上升趋势,而……则急剧下降。" },
      { en: "The figure for X peaked at around...before falling to...", zh: "X 的数值在约……达到峰值,随后降至……" },
      { en: "In 2012, renewables overtook coal for the first time.", zh: "2012年,可再生能源首次超过煤炭。" },
  ...
  },
  {
    ...
    outline: [
      ...
      "概述(Overview):指出最突出的总体规律(如各国最大开支项是什么、哪国某项最高/最低),不堆数字",
      "主体段1:横向比较各国占比最大的类别(如住房/食品),突出最高与最低",
      "主体段2:比较其余类别(交通、休闲、其他)的差异,指出显著的国家差距",
      "数据有取舍,聚焦最大、最小与最明显的差异,使用百分比比较结构,不写个人观点"
    ],
    useful_phrases: [
      { en: "The table compares the proportion of household income devoted to...", zh: "该表格比较了用于……的家庭收入比例。" },
      { en: "The largest share of spending in X went on..., accounting for...%.", zh: "X 国占比最大的开支为……,占……%。" },
      { en: "Households in X allocated considerably more to...than those in Y.", zh: "X 国家庭在……上的支出远多于 Y 国。" },
      { en: "At just...%, the figure for...was the lowest of the three.", zh: "仅为……%,……是三国中最低的。" },
    ...
    checklist: [
      ...
      "以国家之间的横向比较为主线",
      "用了多种比较表达(double/highest/lowest/comparable 等)",
      "聚焦最大值、最小值与最显著差异",
      "词数 ≥150"
    ]
  },
  {
    ...
    outline: [
      ...
      "主体段1:让步——承认支持艺术的合理理由(文化价值、教育、经济与旅游),用例子",
      "主体段2:反驳/我方核心——道路与公共服务关乎安全、健康与日常生计,优先级更高,用例子",
      "主体段3(可在段尾):提出平衡观点——并非二选一,应保证基本服务后再资助艺术",
      "结论:重申立场——总体上公共服务应优先,但不应完全忽视艺术"
    ],
    useful_phrases: [
      { en: "It is sometimes argued that...should take priority over...", zh: "有人主张……应优先于……" },
      { en: "While I acknowledge the cultural value of..., I am inclined to disagree that...", zh: "尽管我承认……的文化价值,但我倾向于不同意……" },
      { en: "A compelling reason for this is that...", zh: "一个有力的理由是……" },
      { en: "This is not to say that...should be neglected entirely; rather,...", zh: "这并非说……应被完全忽视;相反……" },
  ...
  },
  {
    ...
    outline: [
      ...
      "主体段1(原因):分析主要成因(私家车数量激增、公共交通不足、城市规划落后/人口集中),配例子",
      "主体段2(对策):针对成因给出可行解决方案(发展公共交通、拥堵收费/限行、远程办公与错峰),配例子并说明效果",
      "可在对策段强调对策与原因的对应关系,体现逻辑闭环",
      "结论:总结主要成因并重申最有效的对策"
    ],
    useful_phrases: [
      { en: "There are several factors contributing to this problem.", zh: "造成这一问题的因素有若干。" },
      { en: "The root cause lies in the sharp rise in private car ownership.", zh: "根本原因在于私家车保有量的急剧上升。" },
      { en: "One effective measure would be to invest heavily in public transport.", zh: "一项有效措施是大力投资公共交通。" },
      { en: "If governments imposed congestion charges, drivers would be deterred from...", zh: "如果政府征收拥堵费,司机就会被劝阻不去……" },
